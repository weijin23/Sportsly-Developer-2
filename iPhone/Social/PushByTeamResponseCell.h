...
@interface PushByTeamResponseCell : BaseTableCell


@property(nonatomic,strong) IBOutlet UIImageView *statusimagvw;
...
@property(nonatomic,strong) IBOutlet UIImageView *leftimagetime;
